...
SECRET_KEY = 'lpxvm&3zmfk_i$&dag^jaizb+jlwj%9oiqq-2@j#)r1qo0*_pa'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR.parent.joinpath('frontend/app/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR.parent / 'db_data/' / 'db.sqlite3',
    }
}
